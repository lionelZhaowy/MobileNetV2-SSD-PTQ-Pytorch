...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_path      = 'logs/vgg-SSD-train/vgg_best_epoch_weights96_99.pth'
    ...
    lr_limit_min    = 3e-8 if optimizer_type == 'adam' else 5e-8
    ...
    gen     = DataLoader(train_dataset, shuffle = shuffle, batch_size = batch_size, num_workers = num_workers, 
                        pin_memory=True,drop_last=True, collate_fn=ssd_dataset_collate, sampler=train_sampler)
    gen_val = DataLoader(val_dataset  , shuffle = shuffle, batch_size = batch_size, num_workers = num_workers,
                        pin_memory=True, drop_last=True, collate_fn=ssd_dataset_collate, sampler=val_sampler)
    ...
    for epoch in range(Init_Epoch, UnFreeze_Epoch):
        ...
        # fit_one_epoch(model, criterion, optimizer, epoch_step, epoch_step_val, gen, gen_val, fp16, scaler)
