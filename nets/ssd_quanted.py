...
from nets.mobilenetv2_quanted import InvertedResidual, mobilenet_v2
...
class SSD300(nn.Module):
    def __init__(self, num_classes, backbone_name, pretrained = False):
        ...
        if backbone_name    == "vgg":
            ...
            #---------------------------------------------------#
            for k, v in enumerate(backbone_source):#前两个有效特征层
            ...
            #-------------------------------------------------------------#  
            for k, v in enumerate(self.extras[1::2], 2):#后四个有效特征层
